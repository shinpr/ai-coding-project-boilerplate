...
Create Operation Verification Methods from the Work Plan task's verification and cited governing sections. Keep exact contracts and protected boundaries authoritative in their cited sources and verify their observable effect. Select the verification level (L1/L2/L3) per the implementation-approach skill.
