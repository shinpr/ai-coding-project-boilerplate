...
Address a missing prerequisite as part of the E2E test implementation task itself, or move the verification to the `fixture-e2e` lane when the behavior under test does not require a live service.
