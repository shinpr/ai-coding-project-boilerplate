...
規模判定完了後、**sub-agents.mdの該当フロー全ステップをTodoWriteに登録**。登録後、TodoWriteを参照してフローを進める。
...
**フロー厳守**: sub-agents.mdの「自律実行中のタスク管理」に従い、TodoWriteで4ステップを管理する
...
### タスク実行フロー
sub-agents.mdの「自律実行中のタスク管理」に従い、TodoWriteで以下の4ステップを管理：
1. task-executor実行
