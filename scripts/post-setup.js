...
function showNextSteps() {
  ...
  console.log('   pnpm lang:ja   # Switch to Japanese')
  console.log('   pnpm lang:en   # Switch to English')
  console.log('   pnpm lang:zh-CN # Switch to Simplified Chinese\n')
  console.log('📖 Available commands:\n')
  console.log('   pnpm dev         # Start development')
  console.log('   pnpm build       # Build for production')
  console.log('   pnpm test        # Run tests')
  console.log('   pnpm check:all   # Run all quality checks\n')
